<template>
  <div class="app-container">
      ...
      >
        ...
        >
          ...
          <!-- <span
            ...
            "
          >
            <el-button type="primary" size="mini" round>删除</el-button></span
          >
          <span
            style="
              float: right;
            ...
            "
          >
            <el-button type="warning" size="mini" round>编辑</el-button></span
          > -->
        </el-option>
      </el-select>
    ...
    <el-dialog title="新增基础信息" :visible.sync="adddialogVisible">
      <el-form :model="adddialogForm"  size="medium">
    ...
    <el-dialog
      ...
      width="50%"
    >
      <el-form :model="addtypeform" label-width="100px" size="medium">

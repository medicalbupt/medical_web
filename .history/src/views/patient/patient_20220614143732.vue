    ...
    >
      ...
      <el-form label-width="100px" ref="addFormRef" :model="addForm">
        ...
        <el-form-item label="现病史">
          <el-input
            v-model="addForm.curMedicalRecordList[0]"
            :rows="5"
            placeholder="请输入内容"
            type="textarea"
          ></el-input>
        ...
        <el-form-item label="既往史">
          <el-input
            v-model="addForm.pastHistoryList[0]"
            :rows="5"
            placeholder="请输入内容"
            type="textarea"
          ></el-input>
        ...
        <el-form-item label="个人史">
          ...
          <div class="div1">
            <el-tag class="tag1">啤酒数量（两/天）</el-tag>
            <el-input-number
          ...
          <div class="div1">
            <el-tag class="tag1">白酒数量（瓶/天）</el-tag>
            <el-input-number
        ...
        <el-form-item label="家族史">
          <!-- <el-input
            ...
            placeholder="请输入内容"
            auto-complete=""
            v-model="addForm.familyHistoryList[0]"
            type="textarea"
          ></el-input> -->
          <el-checkbox-group v-model="checkedCities">
            <el-checkbox v-for="item in familyHistoryListOptions" :label="item" :key="item">{{
              city
            }}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      value: "",
      // 家族史多选
      familyHistoryListOptions: ["糖尿病", "高血压", "冠心病"],
      // 添加用户数据的对象
      addForm: {
        birthday: "",
        createTinme: "",
        curMedicalRecordList: [],
        engravedDisease: "",
        mainComplaint: "",
        familyHistoryList: [],
        gender: "",

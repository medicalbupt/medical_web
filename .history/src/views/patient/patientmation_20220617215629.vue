  ...
  <div>
    ...
    >
      ...
      <el-descriptions-item>
        ...
        <p v-if="patinentform.pastHistoryList.includes(1)">糖尿病</p>
        <p v-if="patinentform.pastHistoryList.includes(2)">慢性肾脏病</p>
        <p v-if="patinentform.pastHistoryList.includes(3)">甲状腺疾病</p>
        <p v-if="patinentform.pastHistoryList.includes(3)">甲状腺疾病</p>

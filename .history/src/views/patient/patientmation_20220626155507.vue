...
export default {
  ...
  computed: {
    ...
    personalHistorytext: function () {
      ...
      if (this.patinentform.personalHistory.includes(1)) {
        return xiyan;
      } else if (this.patinentform.personalHistory.includes(2)) {
        return baijiu;
      } else if (this.patinentform.personalHistory.includes(3)) {
        return pijiu;
      }
    },
    // 家族史展示

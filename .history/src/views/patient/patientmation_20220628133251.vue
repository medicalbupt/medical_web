        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="证候分类">
              <span>虚</span>
              <span>{{ props.row.symptomCategories.real[0].dataName }}</span>
              <span v-if="props.row.symptomCategories.real.includes(1)"
                >男</span
              >
              <!-- <span>{{ props.row.symptomCategories }}</span> -->
            </el-form-item>
            <el-form-item label="其他诊断">
              <span>{{ props.row.otherDiagnosisId }}</span>
            </el-form-item>
            <el-form-item label="病位">
              <span>{{ props.row.diseaseLocation }}</span>
            </el-form-item>
            <el-form-item label="医嘱">
              <span>{{ props.row.doctorOrder }}</span>
            </el-form-item>
            <el-form-item label="合并用药">
              <span>{{ props.row.combinationTherapy }}</span>
            </el-form-item>
            <el-form-item label="DM/CKD VAS评分">
              <span>{{ props.row.vasScore }}</span>
            </el-form-item>
            <el-form-item label="风邪">
              <span>{{ props.row.windEvil }}</span>
            </el-form-item>

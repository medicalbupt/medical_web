      ...
      <el-form :model="patinenteditform" ref="editFormRef" label-width="100px">
        ...
        <el-form-item label="现病史">
          <el-input type="textarea"
            :rows="5" v-model="patinenteditform.curMedicalRecord"></el-input>
        </el-form-item>
        <el-form-item label="家族史">
          <el-input type="textarea"
            :rows="5" v-model="patinenteditform.familyHistory"></el-input>
        </el-form-item>
        <el-form-item label="既往史">
          <el-input type="textarea"
            :rows="5" v-model="patinenteditform.pastHistory"></el-input>
        </el-form-item>
        <el-form-item label="个人史">
          <el-input type="textarea"
            :rows="5" v-model="patinenteditform.personalHistory"></el-input>
        </el-form-item>
      </el-form>

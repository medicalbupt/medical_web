      ...
      <el-form :model="addconsultform">
        ...
        <el-form-item label="症状" :label-width="formLabelWidth">
          ...
          <el-table style="width: 100%">
            ...
            <el-table-column label="症状类别" prop="id"> </el-table-column>
          </el-table>
        </el-form-item>
  ...
  methods: {
    ...
    getsymtomlist() {
      ...
      getcommonlist(typeList).then((res) => {
        ...
        for (var i = 0; i < res.datacommonDataEntityList.length(); i++) {
          if (res.commonDataEntityList[i].typeId == 3) {
            this.form3 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 4) {
            this.form4 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 5) {
            this.form5 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 6) {
            this.form6 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 7) {
            this.form7 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 8) {
            this.form8 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 9) {
            this.form9 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 10) {
            this.form10 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 11) {
            this.form11 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 12) {
            this.form12 = res.commonDataEntityList[i];
          } else if (res.commonDataEntityList[i].typeId == 13) {
            this.form13 = res.commonDataEntityList[i];
          }
        }

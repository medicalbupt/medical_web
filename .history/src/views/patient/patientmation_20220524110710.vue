<template>
  <div>
    ...
    <h4>
      该患者的总诊次为：{{
        this.patientconsultData.patientconsultList.consultNum
      }}
      次
    </h4>
    ...
    <el-table :data="patientconsultData.patientconsultList" class="table1">
      ...
      <el-table-column label="患者诊次ID" prop="id"> </el-table-column>
    ...
    async getpationconsult() {
      await getpationconsult(this.consultqueryInfo).then((res) => {
        ...
        if (res.data.respCode == "0000") {
          ...
          this,this.consultNum=this.patientconsultData.patientconsultList.consultNum
          console.log(
            "this.patientconsultData.patientconsultList",
            this.patientconsultData.patientconsultList
          );

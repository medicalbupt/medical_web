          ...
          <el-card class="box-card" shadow="never">
            <el-collapse v-model="activeNames">
              ...
              <el-collapse-item title="是否诊断为风邪证">
                <el-radio v-model="windEvil.diagnosticResult" label="1">是</el-radio>
                <el-radio v-model="windEvil.diagnosticResult" label="0">否</el-radio>
              </el-collapse-item>
            </el-collapse>
          </el-card>
        </el-form-item>

    ...
    >
      ...
      <el-form label-width="100px" ref="addFormRef" :model="addForm">
        ...
        <el-form-item label="既往史">
          <el-checkbox-group v-model="pastHistoryListOptions">
            <el-checkbox v-for="item in pastHistoryListOptions" :label="city" :key="city">{{
              city
            }}</el-checkbox>
          </el-checkbox-group>
          <!-- <el-input
            v-model="addForm.pastHistoryList"
            :rows="5"
            placeholder="请输入内容"
            type="textarea"
          ></el-input> -->
        ...
        <el-form-item label="家族史">
          <el-cascader
            :value="addForm.familyHistoryList"

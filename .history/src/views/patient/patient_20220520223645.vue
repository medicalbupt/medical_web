<template>
  <div id="patient-manager">
    <el-card>
      ...
      <el-table :data="patientData.patientList">
    ...
    <el-dialog title="添加患者" :visible.sync="addDialogVisible" width="50%">
      ...
      <el-form label-width="100px" ref="addFormRef" :model="addForm">
        ...
        <el-form-item label="现病史" prop="curMedicalRecord">
          <el-input
        ...
        <el-form-item label="患者创建时间" prop="createTinme">
          <el-input v-model="addForm.createTinme"></el-input>
        </el-form-item>
        <el-form-item label="患者修改时间" prop="modifiedTime">
          <el-input v-model="addForm.modifiedTime"></el-input>
        </el-form-item>
        <el-form-item label="患者状态" prop="modifiedTime">
          <el-input v-model="addForm.modifiedTime"></el-input>
        </el-form-item>
      </el-form>
      <!-- 底部按钮区域 -->
...
import { addPatient, getPatientList } from "@/api/patient";

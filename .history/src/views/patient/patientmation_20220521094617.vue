...
export default {
  ...
  methods: {
    ...
    getIDlist(id) {
        //  for (const i=0 ; i <=this.patientData.patientList.length ; i--) {
           console.log("this.patientData.patientList.length",this.patientData.patientList.length)
        // this.patientData.patientList[key];
    },
  },
};
</script>

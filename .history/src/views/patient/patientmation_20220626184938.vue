        ...
        <el-form-item label="症状" :label-width="formLabelWidth">
          ...
          >
            ...
            <el-collapse v-model="activeNames" accordion>
              <el-collapse-item  v-if="symtom.typeName == 3" title="全身" name="1">
                <div>
                  <div
              ...
              <el-collapse-item  v-if="symtom.typeName == 4" title="头面" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 5" title="四肢" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 6" title="心胸" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 7" title="脘腹" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 8" title="饮食" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 9" title="睡眠" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 9" title="二便" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 9" title="生殖" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"
              ...
              <el-collapse-item  v-if="symtom.typeName == 9" title="舌" name="1">
                <div>
                  <div
                    v-for="subSymtom in symtom.children"
                    :key="symtom.typeId + '-' + subSymtom.id"

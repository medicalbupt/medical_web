  ...
  <div>
    ...
    >
      ...
      <el-descriptions-item>
        ...
        <span v-if="patinentform.curMedicalRecordList[0] == 1">糖尿病</span>
        <span v-if="patinentform.curMedicalRecordList[1] == 2">慢性肾脏病</span>
        <span v-if="patinentform.curMedicalRecordList[2] == 3">甲状腺疾病</span>
      </el-descriptions-item>
      <el-descriptions-item>
        <template slot="label">
          <i class="el-icon-notebook-1"></i>

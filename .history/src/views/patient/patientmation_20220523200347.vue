<template>
  <div>
    ...
    <!-- 展示患者诊断信息 -->
    <el-table :data="patientData.patientList" class="table1">
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <el-form-item label="患者主要病诊断">
      ...
      <el-table-column label="就诊地点" prop="name"> </el-table-column>
      <el-table-column label="患者就诊时间" prop="desc"> </el-table-column>
    </el-table>

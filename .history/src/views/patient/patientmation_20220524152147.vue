        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="辅助检查">
              <span>
                <img :src="props.row.auxiliaryExamination" class="img1"
              /></span>
            </el-form-item>
            <el-form-item label="其他资料">
              <span><img :src="props.row.additionalInfo" class="img2" /></span>
            </el-form-item>
            <el-form-item label="舌象">
              <span><img :src="props.row.tonguePattern" class="img3" /></span>
            </el-form-item>

  ...
  <div>
    ...
    >
      ...
      <el-descriptions-item>
        ...
        {{ personalHistorytext+patinentform.personalHistory.}}
        <!-- <> -->
      </el-descriptions-item>
      <el-descriptions-item>
        <template slot="label">
        ...
        <!-- <p v-if="patinentform.familyHistoryList.includes(1)">糖尿病</p>
        <p v-if="patinentform.familyHistoryList.includes(2)">高血压</p>
        <p v-if="patinentform.familyHistoryList.includes(3)">冠心病</p> -->
...
export default {
  ...
  computed: {
    ...
    personalHistorytext: function () {
      ...
      if (patinentform.personalHistory.personalType == 1) {
        return xiyan;
      } else if (patinentform.personalHistory.personalType == 2) {
        return baijiu;
      } else if (patinentform.personalHistory.personalType == 3) {
        return pijiu;
      }
    },
  },

      ...
      <el-form :model="addconsultform">
        ...
        <el-form-item label="症状" :label-width="formLabelWidth">
          ...
          <el-collapse v-model="activeName" accordion>
            ...
            <el-collapse-item title="头面" name="1"> </el-collapse-item>
            <el-collapse-item title="四肢" name="1"> </el-collapse-item>
            <el-collapse-item title="心胸" name="1"> </el-collapse-item>
            <el-collapse-item title="脘腹" name="1"> </el-collapse-item>
            <el-collapse-item title="饮食" name="1"> </el-collapse-item>
            <el-collapse-item title="睡眠" name="1"> </el-collapse-item>
            <el-collapse-item title="二便" name="1"> </el-collapse-item>
            <el-collapse-item title="生殖" name="1"> </el-collapse-item>
            <el-collapse-item title="舌" name="1"> </el-collapse-item>
            <el-collapse-item title="脉" name="1"> </el-collapse-item>
          </el-collapse>
        </el-form-item>

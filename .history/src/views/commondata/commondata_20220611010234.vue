<template>
  <div class="app-container">
    <div class="info-container">
      ...
      <el-button type="primary" class="bt1" @click="adddialogVisible = true"
        >新增基础信息</el-button
      >
    ...
    <el-dialog title="收货地址" :visible.sync="adddialogVisible">
      <el-form :model="adddialogForm">
        ...
        <el-form-item label="数据类型" :label-width="formLabelWidth">
          <el-select v-model="adddialogForm.dataType" placeholder="请选择">
    ...
    >
      <el-form :model="editmationform" ref="editFormRef" label-width="100px">
...
export default {
  ...
  methods: {
    ...
    adddinfomation() {
      adddinfomation(this.adddialogForm).then((response) => {

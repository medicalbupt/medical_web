...
export default {
  ...
  methods: {
    ...
    async removeUserById(mation) {
      ...
      this.infomationDeleteform.id = mation.dataType;
      this.infomationDeleteform.id = mation.dataName;
      this.infomationDeleteform.id = mation.dataCode;
      this.infomationDeleteform.id = mation.id;
      console.log("infomationDeleteform的id", this.infomationDeleteform.id);
      infomationDelete(this.patientdeleteform).then((response) => {

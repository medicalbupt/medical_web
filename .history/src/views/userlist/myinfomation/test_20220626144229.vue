<template>
    <div>
        ...
        <div v-for="symtom in symtomList" :key="symtom.typeId">
            ...
            <div>
                <div v-for="subSymtom in symtom.children" :key="symtom.typeId + '-' + subSymtom.id">
...
export default {
    ...
    methods: {
        getSymtomList() {
            ...
            const commonDataEntityList = [{ // 这里我就忽略请求了，就是拿到那个接口的返回值
                typeId: 3,
                typeName: '全身',
                name: '畏寒1',
                id: 10
            ...
            typeList.forEach((type) => {
                const sameTypeList = commonDataEntityList.filter((dataEntity) => {
            ...
            typeList.forEach((type) => {
                if(symtomMap[type] && symtomMap[type].length !== 0) {
                    ...
                    this.symtomList.push({
                        typeId: type,
                        typeName: symtomMap[type][0]['typeName'],

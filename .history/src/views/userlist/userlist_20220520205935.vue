  ...
  <div class="app-container">
    ...
    >
      <el-form :model="editForm" ref="editFormRef" label-width="100px">
        ...
        <el-form-item label="用户创建时间">
          <el-input v-model="editForm.modifiedTime" disabled></el-input>
        </el-form-item>
        <el-form-item label="用户创建时间">
        ...
        <el-form-item label="用户创建时间">
          <el-input v-model="editForm.rolePriority" disabled></el-input>
        </el-form-item>
        <el-form-item label="用户创建时间">
...
<script>
import { pageBatchQuery, useradd, userdelete, getInfo2 } from "@/api/user";
export default {
  name: "userlist",
  data() {
    return {

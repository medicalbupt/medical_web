...
export default {
  ...
  data() {
    const validateUsername = (rule, value, cb) => {
      let regEmail =
        /^^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$ /; // 字母开头+数字
  ...
  created() {
    axios
      .get("http://47.104.97.211:8080/ZUNren/user/getSessionId")
      .then((res) => res.data)
      .then((data) => {
        console.log("sessionIddata", data);
        this.loginForm.sessionId = data.sessionId;
        this.imgUrl =
          "http://47.104.97.211:8080/ZUNren/user/getAuthCode?sessionId=" +

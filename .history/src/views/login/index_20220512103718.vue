...
export default {
  ...
  created() {
    axios.get("http://47.104.97.211:8080/ZUNren/user/getSessionId")
            .then(res=>res.data)
            .then(data=>{
              console.log("sessionIddata",data)
              this.loginForm.sessionId=data.sessionId
              this.imgUrl='http://47.104.97.211:8080/ZUNren/user/getAuthCode?sessionId='+this.loginForm.sessionId
